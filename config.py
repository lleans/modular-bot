...
class ModularBotConst:
	class Color:
		RANDOM: list[str] = ["ffe552", "ffc052", "ff7d52", "ff5252", "ff5289", "ff5252"]
		SUCCESS: str = "198754"
		FAILED: str = "CA0B00"
		WARNING: str = "E49B0F"
		NEUTRAL: str = "0E86D4"
	...
	class Image:
		RANDOM: list[str] = [
			"https://i.imgur.com/ImFzDtd.gif",
			"https://i.imgur.com/vSIWwxP.gif",
			"https://i.imgur.com/tXnd4IZ.gif",
			"https://i.imgur.com/IverxEm.gif",
		]
	...
	SERVER_NAME: str = getenv("SERVER_NAME", "Server Name")
	BOT_NAME: str = getenv("BOT_NAME", "Modular BOT")
	BOT_PREFIX: str = getenv("BOT_PREFIX", "!mdlr")
...
class GuildMessage:
	...
	DM_MESSAGE: str = (
		f"Selamat datang di **{ModularBotConst.SERVER_NAME}!**\n.\n.\n.\n.\n"
