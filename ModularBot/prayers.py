...
class Prayers:
	...
	__EATS_IMAGES = [
		"https://i.imgur.com/1uVOu9s.gif",
		"https://i.imgur.com/lrrIzRY.gif",
		"https://i.imgur.com/eWe8VvA.gif",
		"https://i.imgur.com/gFVKP74.gif",
		"https://i.imgur.com/tW3Hjcb.gif",
		"https://i.imgur.com/ey1KKAd.gif",
		"https://i.imgur.com/Tgx5w3E.gif",
	]
	__CHEER_IMAGES = [
		"https://i.imgur.com/I24KR5n.gif",
		"https://i.imgur.com/L2Yk6a2.gif",
		"https://i.imgur.com/cRJQcfJ.gif",
		"https://i.imgur.com/IV5Nadb.gif",
		"https://i.imgur.com/zCSohsn.gif",
		"https://i.imgur.com/OGesUM4.gif",
	...
	async def get_prayertime(cls, session: ClientSession) -> dict | None:
		...
		while not res:
			async with session.get(
				cls.__PRAYER_API + "/" + cls.__PRAYER_LOCATION
			) as resp:
				if resp.status == 200:
		...
		for pray, prayt in praytimes.items():
			...
			if prayt == time.strftime("%H:%M"):
				...
				if pray == "Maghrib":
					...
					e.description = (
						"Selamat Berbuka Puasa. Bersyukurlah kalian bisa berbuka dengan makanan enak, diluar sana masih banyak yang belum bisa kayak kamu. "
					...
					e.description = (
						"Waktunya Tarawih. Bukanya Tarawih, malah buka nHen..., salat dulu yang bener!!.\n\n"
						+ e.description
					)
					...
					e.description = (
						f"Waktunya Salat {pray}. Salat yang khusyuk, biar bisa ketemu waifu di isekaid.\n\n"
						+ e.description
					)

			if pray != "ramadhan":
				e.add_field(
					name=f"{pray + ' (Buka)' if pray == 'Maghrib' else pray}:",
					value=prayt,
				)
